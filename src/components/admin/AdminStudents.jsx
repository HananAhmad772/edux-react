...
import { GraduationCap, Users, BookOpen, Award, TrendingUp, Search, Filter, Download, Eye, Trash2 } from 'lucide-react';
...
const AdminStudents = () => {
  ...
  ).filter(student => filterStatus === 'all' || student.status.toLowerCase() === filterStatus);
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">38,750</p>
              <p className="text-sm font-medium mt-1 text-green-600">+15.2% from last month</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">15,680</p>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredStudents.map((student) => (
                <tr key={student.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{student.coursesEnrolled} enrolled</div>
                    <div className="text-sm text-gray-500">{student.coursesCompleted} completed</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
